...
export class Question36Page implements OnInit {
  ...
  async checkAnswers() {
    ...
    const isCorrect =
      ...
      this.ans78 === correctAnswers.ans78 &&
      this.ans79 === correctAnswers.ans79 &&
      this.ans80 === correctAnswers.ans80 &&
      this.ans81 === correctAnswers.ans81 &&
      this.ans82 === correctAnswers.ans82;
